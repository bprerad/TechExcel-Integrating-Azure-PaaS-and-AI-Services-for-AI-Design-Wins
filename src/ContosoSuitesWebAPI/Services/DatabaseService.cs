...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("Minimum beginning date")] DateTime dt)
    {
    ...
    /// <summary>
    /// Get bookings that do not have associated hotel rooms.
    /// </summary>
    [KernelFunction]
    ...
    /// <summary>
    /// Get bookings with more than one hotel room.
    /// </summary>
